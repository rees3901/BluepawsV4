...
(library Library_1
	...
	(patternDef "SM03BSRSSTBLFSN" (originalName "SM03BSRSSTBLFSN")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.388) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 1.787) (pt 2.5 1.787) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.5 1.787) (pt 2.5 -2.463) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.5 -2.463) (pt -2.5 -2.463) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.5 -2.463) (pt -2.5 1.787) (width 0.025))
		)
	...
	(compDef "SM03B-SRSS-TB_LF__SN_" (originalName "SM03B-SRSS-TB_LF__SN_") (compHeader (numPins 5) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "http://www.jst-mfg.com/product/pdf/eng/eSR.pdf")
		(attr "<Component Height>" "2.9")
		(attr "<STEP Filename>" "SM03B-SRSS-TB_LF__SN_.stp")
		(attr "<STEP Offsets>" "X=0;Y=1.81;Z=2.96")
