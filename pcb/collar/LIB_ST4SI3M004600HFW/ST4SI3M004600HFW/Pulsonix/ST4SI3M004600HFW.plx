...
//21156893/1983153/2.50/9/2/Integrated Circuit
...
(library Library_1
	...
	(padStyleDef "r430_350"
		(holeDiam 0)
		(padShape (layerNumRef 1) (padShapeType Rect)  (shapeWidth 3.5) (shapeHeight 4.3))
		(padShape (layerNumRef 16) (padShapeType Ellipse)  (shapeWidth 0) (shapeHeight 0))
	)
	(textStyleDef "Normal"
		(font
	...
	(patternDef "SON127P600X500X100-9N" (originalName "SON127P600X500X100-9N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r95_45) (pt -2.9, 1.905) (rotation 90))
			(pad (padNum 2) (padStyleRef r95_45) (pt -2.9, 0.635) (rotation 90))
			(pad (padNum 3) (padStyleRef r95_45) (pt -2.9, -0.635) (rotation 90))
			(pad (padNum 4) (padStyleRef r95_45) (pt -2.9, -1.905) (rotation 90))
			(pad (padNum 5) (padStyleRef r95_45) (pt 2.9, -1.905) (rotation 90))
			(pad (padNum 6) (padStyleRef r95_45) (pt 2.9, -0.635) (rotation 90))
			(pad (padNum 7) (padStyleRef r95_45) (pt 2.9, 0.635) (rotation 90))
			(pad (padNum 8) (padStyleRef r95_45) (pt 2.9, 1.905) (rotation 90))
			(pad (padNum 9) (padStyleRef r430_350) (pt 0, 0) (rotation 0))
		)
	...
	(symbolDef "ST4SI3M004600HFW" (originalName "ST4SI3M004600HFW")
	...
	(compDef "ST4SI3M004600HFW" (originalName "ST4SI3M004600HFW") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "GND") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "2" (pinName "SWIO") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "3" (pinName "I/O") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "7" (pinName "__RESET") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "CLK") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "NC_2") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ST4SI3M004600HFW"))
		(attachedPattern (patternNum 1) (patternName "SON127P600X500X100-9N")
			(numPads 9)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "ST4SI3M004600HFW")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "ST4SI3M004600HFW")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/st4si3m004600hfw/stmicroelectronics.html?utm_currency=USD&region=nac")
		(attr "Description" "GSMA eSIM for IoT system on chip solution for IoT environment")
		(attr "<Hyperlink>" "https://estore.st.com/en/st4si3m004600hfw-cpn.html")
		(attr "<Component Height>" "1")
		(attr "<STEP Filename>" "ST4SI3M004600HFW.stp")
