...
(library Library_1
	...
	(patternDef "SON127P600X500X100-9N" (originalName "SON127P600X500X100-9N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -3 1) (pt -1.5 2.5) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "ST4SI3M004600HFW" (originalName "ST4SI3M004600HFW") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "SWIO") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "I/O") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "5" (pinName "NC_2") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://estore.st.com/en/st4si3m004600hfw-cpn.html")
		(attr "Height" "1 mm")
	)
